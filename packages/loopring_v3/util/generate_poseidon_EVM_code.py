...
def poseidon_EVM_asm(params):
    ...
    o = o + "function hash_t8f6p53(" + struct + " memory i, uint q) internal pure returns (uint)\n{\n"
    o = o + "// validate inputs\n"
    for i in range(params.t):
...
poseidonParamsEVM = poseidon_params(SNARK_SCALAR_FIELD, 8, 6, 53, b'poseidon', 5, security_target=128)
